import 'package:medicall_app/widgets/custom_indicator.dart';
    ...
    return Scaffold(
      body: Column(
        ...
        children: [
          ...
          Image.asset(onboardingItemToShow.asset, width: 500, height: 350),
...
//model this should be in its own seperate folder
